...
def get_accuracy(sim, tf_sess, labels):
    return tf_sess.run(
        sim.per_batch_accuracy(labels=tf.constant(labels), predictions=sim.predictions())
    )
